...
function makeTargetList()
{
	...
	{
		options += "<option value='"+ targetList[i][0] + "'>" +targetList[i][0] +" "+ targetList[i][1]+"</option>";
	}
...
function init()
{
	...
	document.querySelector("#importArea").onclick = importAreaClose;
	document.querySelector("#importOK").onclick = importOK;
	document.querySelector("#importCancel").onclick = importAreaClose;
